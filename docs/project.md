...
Each student **must** design and execute the class project on their own. Ideally, we presume each of you has a research project for your degree program. This project is an excellent place to start. Think about how you can apply open science practices to your project, then actually do it.  

Some possible action items include:

- Publish your data in a FAIR-compatible repository
- Write documentation for your code, and publish it altogether
...
#### Write-up (due Oct 27th, 23:59 pm UTC+8)

A short one-pager describing the research topic and anticipated open-science highlights.
...
#### Oral presentation (Nov 3rd, 10-11:30 am during the class)

Each person will spend 10 minutes talking about the project, followed by a 5-10 minute discussion. We will determine the presentation order when the class starts. 
...
- Presentation should include why you chose this topic, what you will achieve, and what the open science highlights are.

### Final report

#### Oral presentation (Dec 15th, 10-11:30 am during the class)
...
- In addition to the oral component, visual material such as slides, real-time demos, or videos is required. You have several ways to present your work:
  - Send the files or links to me (whyjz@csrsr.ncu.edu.tw) before the class starts. Note that my laptop runs Ubuntu only with LibreOffice installed, so PDF or cloud-based material (e.g., Google Slides) are the preferred formats.
  - Bring and use your own laptop (with an HDMI output) to present your work.
  - Publish material on your GitHub Pages and showcase it during the talk.
...
- Ideally the talk should be between 13 and 15 minutes long. It is the presenter's responsibility to manage the talk length, as we will *not* set up a public timer. I will time the talks privately for grading purposes.  
...
#### Write-up (due Dec 22nd; grading period: TBD)

The final term paper should be built and published using Jupyter Book on your personal GitHub Pages. You can find a template [here](template.html). You can update the published HTML as many times as you wish before the grading period; in fact, I recommend that you build your final report ahead of time so we'll not be desperately rushing through debugging. After the grading period, you can choose to leave the report online or remove it from public view. 
